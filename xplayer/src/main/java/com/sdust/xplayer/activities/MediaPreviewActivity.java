...
import com.sdust.xplayer.helper.ThemeHelper;
...
import com.sdust.xplayer.view.ThemeGroupLayout;
import com.sdust.xplayer.view.ThemeSufaceView;
import com.sdust.xplayer.view.ThemeView;
...
public class MediaPreviewActivity extends BaseActivity implements
	...
	public void onClick(View v) {
		...
		} else if (i == R.id.preview_theme) {
			if (isPlaying())
				stopVideo();
			else
				startVideo();

		} else if (i == R.id.video_preview_theme_volume) {// 隐藏动画
			ToastUtils
					.showToastImage(
							this,
		...
		} else if (i == R.id.video_preview_video_volume) {
			ToastUtils
					.showToastImage(
							this,
		...
		} else if (i == R.id.tab_theme) {
			mThemeLayout.setVisibility(View.VISIBLE);
			mFilterLayout.setVisibility(View.GONE);

		} else if (i == R.id.tab_filter) {
